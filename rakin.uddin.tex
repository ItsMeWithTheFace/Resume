...
\textbf{Teaching Assistant:} Introduction to Databases, Principles of Programming Languages, Calculus
\newline
...
\runsubsection{Ontario Ministry of Education}
\descript{| Cloud Infrastructure Developer Intern}
\location{Sept 2016 – April 2017 | Toronto, CA}
\begin{tightemize}
...
\item Implemented backend in Ruby with authentication and MySQL database as well as the frontend in React
\end{tightemize}
\sectionsep
...
C\# \textbullet{} Ruby \textbullet{} SQL \textbullet{} Haskell \textbullet{}
